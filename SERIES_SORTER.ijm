...
directory_experiment = "/Volumes/Seagate/OMTC/experiments/" + experiment
...
//USER INPUT 3/4: series_start requires the number corresponding to the FIRST series in condition
series_start =1
//USER INPUT 4/4: series_start requires the number corresponding to the LAST series in condition
series_end =7
//eg: in input examples above, positions 1-7 in the experiemnt were of LNCaP at 25 kPa
